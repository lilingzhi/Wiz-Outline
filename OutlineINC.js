...
function PrintContent() {
	if (listContent.length > 0) {
		...
		//
		htmlContent = "<div style=\"font-weight:bold; border-bottom-style:groove;\">Wizhelper 目录 :</div><UL style=\"margin:0px 0px 0px 30px\">" + htmlContent + "</UL>";
...
function PrintBookmark() {
	if (listBookmark.length > 0) {
		...
		if (htmlBookmark.length>0){
			htmlBookmark = "<div style=\"font-weight:bold; border-bottom-style:groove;\">Bookmark 书签 :</div><ul style=\"margin:0px 0px 0px 20px\">" + htmlBookmark + "</ul>";
...
function PrintWiki() {
	if (listWiki.length > 0) {
		...
		if (htmlWiki.length>0) {
			htmlWiki = "<div style=\"font-weight:bold; border-bottom-style:groove;\">Wiki 大纲 :</div><ul style=\"margin:0px 0px 0px 20px\">" + htmlWiki + "</ul>";
...
function PrintH16() {
	if (listH16.length > 0) {
		...
		if (htmlH16.length>0) {
			...
			htmlH16 = "<div style=\"font-weight:bold; border-bottom-style:groove;\">H1~H6 大纲 :</div><ul style=\"margin:0px 0px 0px 20px\">" + htmlH16 + "</ul>";
...
function PrintBold() {
	if (listBold.length > 0) {
		...
		if (htmlBold.length>0) {
			htmlBold = "<div style=\"font-weight:bold; border-bottom-style:groove;\">Bold 大纲 :</div><ul style=\"margin:0px 0px 0px 20px\">" + htmlBold + "</ul>";
